...
const oidcConfig = {
  authority: import.meta.env.VITE_KEYCLOAK_AUTHORITY || "http://localhost:8081/realms/event-tickets-platform",
  client_id: import.meta.env.VITE_KEYCLOAK_CLIENT_ID || "event-tickets-platform-app",
